...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final moodController = Provider.of<MoodController>(context); //Controls container borders when clicked
    final reasonController = Provider.of<ReasonController>(context); //Controls container borders when clicked
                                ...
                                GestureDetector(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      border: moodController.isSelected && _selectedMood == "Happy" ? Border.all(width: 10, color: Colors.grey) : null
                                    ),
                                    child: Center(
                                      child: Image.asset(
                                ...
                                GestureDetector(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      borderRadius: BorderRadius.circular(250),
                                      border: moodController.isSelected && _selectedMood == "Sad" ? Border.all(width: 10, color: Colors.grey) : null
                                    ),
                                    child: Center(
                                      child: Image.asset(
                                ...
                                GestureDetector(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                      color: Colors.red,
                                      borderRadius: BorderRadius.circular(250),
                                      border: moodController.isSelected && _selectedMood == "Angry"  ? Border.all(width: 10, color: Colors.grey) : null
                                    ),
                                    child: Center(
                                      child: Image.asset(
                                ...
                                GestureDetector(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                      color: Colors.green,
                                      borderRadius: BorderRadius.circular(250),
                                      border: moodController.isSelected && _selectedMood == "Calm" ? Border.all(width: 10, color: Colors.grey) : null
                                    ),
                                    child: Center(
                                      child: Image.asset(
                              ...
                              GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    border: reasonController.isSelected && _selectedReason == "Work" ? Border.all(width: 5, color: Colors.grey) : null
                                  ),
                                  child: Center(
                                    child: const Text(
                                      'Work',
                              ...
                              GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color: Colors.black,
                                    borderRadius: BorderRadius.circular(200),
                                    border: reasonController.isSelected && _selectedReason == "School" ? Border.all(width: 5, color: Colors.grey) : null
                                  ),
                                  child: Center(
                                    child: const Text(
                                      'School',
                              ...
                              GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color: Colors.black,
                                    borderRadius: BorderRadius.circular(200),
                                    border: reasonController.isSelected && _selectedReason == "Friends" ? Border.all(width: 5, color: Colors.grey) : null
                                  ),
                                  child: Center(
                                    child: const Text(
                                      'Friends',
                              ...
                              GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color: Colors.black,
                                    borderRadius: BorderRadius.circular(200),
                                    border: reasonController.isSelected && _selectedReason == "Family" ? Border.all(width: 5, color: Colors.grey) : null
                                  ),
                                  child: Center(
                                    child: const Text(
                                      'Family',
                              ...
                              GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color: Colors.black,
                                    borderRadius: BorderRadius.circular(200),
                                    border: reasonController.isSelected && _selectedReason == "Hobby" ? Border.all(width: 5, color: Colors.grey) : null
                                  ),
                                  child: Center(
                                    child: const Text(
                                      'Hobby',
                              ...
                              GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color: Colors.black,
                                    borderRadius: BorderRadius.circular(200),
                                    border: reasonController.isSelected && _selectedReason == "Health" ? Border.all(width: 5, color: Colors.grey) : null
                                  ),
                                  child: Center(
                                    child: const Text(
                                      'Health',
                              ...
                              GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color: Colors.black,
                                    borderRadius: BorderRadius.circular(200),
                                    border: reasonController.isSelected && _selectedReason == "Relationship" ? Border.all(width: 5, color: Colors.grey) : null
                                  ),
                                  child: Center(
                                    child: const Text(
                                      'Relationship',
                              ...
                              GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color: Colors.black,
                                    borderRadius: BorderRadius.circular(200),
                                    border: reasonController.isSelected && _selectedReason == "Money" ? Border.all(width: 5, color: Colors.grey) : null
                                  ),
                                  child: Center(
                                    child: const Text(
                                      'Money',
